...
import manageaccounts from '../../assets/Account View.png';
    ...
    <nav className="w-full bg-gradient-to-r from-gray-800 to-gray-600 p-4">
      <div className="flex items-center justify-between">
        ...
        <button type="button" onClick={() => { navigate('/user/ManageDevice') }}>
          ...
          <button type="button" onClick={() => { navigate('/manageaccounts') }}>
            <img className="h-8 w-8" src={manageaccounts} alt="manageaccounts" />
          </button>
          <button type="button" onClick={() => { navigate('/archives') }}>
            <img className="h-8 w-8" src={archives} alt="archives" />
          </button>
        </div>
